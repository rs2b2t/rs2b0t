...
// Why: a row saying `crossed by` names the module that gets there without the pack, the way Isafdar is crossed on the seam graph, and stays listed because no pack edge will ever open it.
