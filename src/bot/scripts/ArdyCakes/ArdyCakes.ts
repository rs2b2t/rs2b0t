...
import { matchesAny, shouldEat } from '../../api/inventory/packRules.js';
import { foodHealAmount } from '../../api/combat/food.js';
import { HOSTILE_NAMES, isHostileAttacker } from '../../api/thieving/targets.js';
import { CAKE_ITEMS, FLEE_TILE, LOCKOUT_TICKS, STAND } from '../../api/thieving/cakeStallData.js';
