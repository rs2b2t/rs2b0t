...
import { chooseTarget, isHostileAttacker, requiredThieving, targetSpot } from '../../api/thieving/targets.js';
...
import { STUN_COMBAT_TICKS, withdrawTo } from '../../api/thieving/stealRules.js';
