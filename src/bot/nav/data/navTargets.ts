...
export const NAV_TARGETS: NavTarget[] = [
    ...
    { bot: 'ClueSolver', label: 'simple011 Varrock East bank upstairs', tile: { x: 3250, z: 3419, level: 1 } },
    { bot: 'ClueSolver', label: 'simple015 Falador house', tile: { x: 2972, z: 3386, level: 1 } },
    ...
    { bot: 'ClueSolver', label: 'vague014 Falador-area house', tile: { x: 3036, z: 3347, level: 1 } },
    { bot: 'ClueSolver', label: 'vague021 Ardougne house', tile: { x: 2656, z: 3322, level: 1 } },
    { bot: 'ClueSolver', label: 'vague023 Catherby house', tile: { x: 2809, z: 3452, level: 1 } },
