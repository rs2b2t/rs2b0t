...
import { SPECIAL_CROSSINGS, specialCrossingAt, specialCrossingForTransport, pickChoice, meetsRequirement, meetsSkill, matchesUseItem, type SpecialCrossing } from './data/specialCrossings.js';
