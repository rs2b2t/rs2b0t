...
that bot's script, logs out, and switches automatically. A logged-in account signs
back in on the destination world with its saved script settings. Start the script
again when ready.
