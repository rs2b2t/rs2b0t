// Reproduce the openBooth wedge: start SmelterBot standing at (3271,3167) — 2
// tiles off the bank stand, non-adjacent to any booth (the exact tile from the
...
try {
    ...
    // Land exactly on (3271,3167): region 51,49 base=(3264,3136), local (7,31).
    ...
    for (let i = 0; i < 30; i++) { // ~60s
        ...
        if (ore > 0) { opened = true; break; } // withdrew ore => bank opened
