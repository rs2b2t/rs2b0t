 ...
 *  Why: `--stage` sets `%squire` and relogs since update_questlist only recolours the journal entry at login; the bank holds coins and food alone, since a stage-6 run handed a pickaxe passes while the quest cannot mine. */
