 ...
 *  Why: `--stage` relogs since update_questlist only recolours the journal at login; stats are 70 rather than `~maxme` so reach and damage problems stay visible; the bank holds coins and food alone so the spade, poison, fish food and closet key are sourced in the world. */
