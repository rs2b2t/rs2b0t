...
export function privateScenario(name: PrivateScenario) {
    ...
    const guardian = name === 'guardian';
    return { name, casketOnly, clueId: guardian ? 3548 : 3544, casketId: guardian ? 3549 : 3545,
        clue: guardian ? 'trail_clue_hard_sextant025' : 'trail_clue_hard_sextant023',
        ...
        bank: { x: 2946, z: 3369, level: 0 }, dig: guardian ? { x: 2581, z: 3030, level: 0 } : { x: 3441, z: 3419, level: 0 } } as const;
}
