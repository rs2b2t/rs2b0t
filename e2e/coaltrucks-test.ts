...
//   bun e2e/coaltrucks-test.ts --phase cross --speed 300 --minutes 3   # proves the log balance level
//   bun e2e/coaltrucks-test.ts --phase fill  --speed 300 --minutes 8
//   bun e2e/coaltrucks-test.ts --phase drain --speed 300 --minutes 8
//   bun e2e/coaltrucks-test.ts --minutes 45                            # full uncheated loop
