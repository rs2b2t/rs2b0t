...
The team scans the visible chamber for KQ loot throughout combat and respawn waits, including items another team left behind. Rune, mithril and iron arrows are ignored. Heartbeats elect one collector among members that can see and carry a drop; private drops remain available to their owner. Gear takes priority over other drops. Pickup requests do not block eating, and inventory growth confirms success. A vanished target releases the collector back to combat after a short confirmation grace period. Empty vials make room first; valuable gear can use the normal eating action to free a slot while preserving at least two sharks and all escape supplies. Team chat reports collection, and confirmed items appear in the Loot paint.
