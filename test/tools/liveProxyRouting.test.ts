...
test('real one-listener proxy isolates all fixture worlds and rejects invalid routes/builds', async () => {
    ...
    expect(output).toContain('three-world HTTP/game/cache routing');
}, 15000);
