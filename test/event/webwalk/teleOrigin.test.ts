...
import { PathFinder, type DoorEdgeData } from '#/bot/event/webwalk/PathFinder.js';
import { teleportAllowedByPolicy } from '#/bot/event/webwalk/policy.js';
import {
    SPELL_TELEPORTS,
    teleportAllowedFromOrigin,
    teleportById
} from '#/bot/event/webwalk/teleportCatalog.js';
import {
    GLORY_MAX_WILDERNESS,
    SPELL_MAX_WILDERNESS,
    wildernessLevelAt
} from '#/bot/event/webwalk/wilderness.js';
