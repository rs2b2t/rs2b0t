...
const EVERY_REPLY: string[] = [
    ...
    'Got your Iron ore Elliott. Trade me.',
    'Resetting. Trade me again in a moment.',
    'Already reset. Ask again in 10m.',
    `Elliott, I could only get ${formatGp(60)} x Iron ore. Trade me.`,
    'Elliott, I could not get your Iron ore. Ask me again.',
    'I have no Iron ore right now.',
    ...HELP_LINES,
    'Put items in and I price them as you go. To buy, say what you want first.',
    `${formatGp(100)} x Iron ore = ${formatGp(2200)}gp. Put that up.`,
