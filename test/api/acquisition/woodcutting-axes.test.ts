...
describe('bestAxe', () => {
    ...
    test('no woodcutting gate: every tier chops at level 1', () => {
        expect(bestAxe(1, bank(['Rune axe', 'Adamant axe']))).toBe('Rune axe');
        expect(bestAxe(20, bank(['Adamant axe', 'Mithril axe', 'Steel axe']))).toBe('Adamant axe');
        expect(bestAxe(5, bank(['Steel axe', 'Iron axe']))).toBe('Steel axe');
    });
    ...
    test('every axe tier is usable at woodcutting 1', () => {
